...
//  cube rho_a = getGaussDistr(coord_a,R, The, Phi, X, Y, Z, sig);
  cube rho_a = getGaussDistrFourier(coord_a, R, The, Phi, X, Y, Z, sig);
//  cube rho_b = getGaussDistr(coord_b,R, The, Phi, X, Y, Z, sig);
  cube rho_b = getGaussDistrFourier(coord_b, R, The, Phi, X, Y, Z, sig);
//  cube rhoAll = getGaussDistr(coord,R, The, Phi, X, Y, Z, sig);
  cube rhoAll = getGaussDistrFourier(coord, R, The, Phi, X, Y, Z, sig);
